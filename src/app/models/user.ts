export class User {
  ...
  setTESTdata() {//тестовые данные
    ...
    this.face = "";
    this.education = [{ "id": 144, "name": "Step1", "specialization": "full dev steck1", "from_year": "1991-01-01", "to_year": "2008-05-01T21:00:00.000Z", "about": "test" }, { "id": 2, "name": "Step", "specialization": "full dev steck", "from_year": "1993-01-01", "to_year": "2020-01-01", "about": "test" }]
    //this.links=[];
